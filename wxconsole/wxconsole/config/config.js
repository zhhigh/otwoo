...
*/
	server:'rrestjs',     
	poweredBy: 'node.js',
	listenPort:8080,//监听端口，如果配合clusterplus监听多个端口，这里也可以使用[3000, 3001, 3002, 3003]数组形式，rrestjs会智能分析
  ...
  //baseDir:processPath,//这里是根据启动nodejs的命令目录来设置baseDir
    autoCreateFolders:true,//如果想要以node_modules加载rrestjs,则此项最好选择true,rrestjs会根据config自动创建静态文件目录和缓存目录等目录
	...
	staticFolder:'/view/static',  //自动响应静态文件的根目录，比如  http://rrestjs.com/static/rrest.jpg 将返回 baseDir+'/example/static/rrest.jpg' 
